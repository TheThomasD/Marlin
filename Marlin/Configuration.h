...
#define Z_MIN_PROBE_ENDSTOP_INVERTING false // Set to true to invert the logic of the probe.        // DIGA-Tech: set to true for BABYSTEPPING
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.12, 80, 404.03, 451.24 }         // DIGA-Tech:
