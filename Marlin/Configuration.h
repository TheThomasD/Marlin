...
#define PIDTEMPBED
  ...
  #define DEFAULT_BED_KP 116.14
  #define DEFAULT_BED_KI  22.50
  #define DEFAULT_BED_KD 399.60
...
#define DELTA
  ...
  #define DELTA_HEIGHT 299.15             // (mm) Get this value from G33 auto calibrate

  #define DELTA_ENDSTOP_ADJ { -0.28, 0.00, -0.28 } // (mm) Get these values from G33 auto calibrate

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS 132.33             // (mm) Get this value from G33 auto calibrate

  // Trim adjustments for individual towers
  // tower angle corrections for X and Y tower / rotate XYZ so Z tower angle = 0
  // measured in degrees anticlockwise looking from above the printer
  #define DELTA_TOWER_ANGLE_TRIM { -0.27, +0.41, -0.13 } // (mm) Get these values from G33 auto calibrate
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 100, 100, 100, 30}
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -1.7, -35.0, -2.5 } // (mm) X, Y, Z distance from Nozzle tip to Probe trigger-point
...
#define Z_PROBE_FEEDRATE_FAST (720) // (mm/min)
