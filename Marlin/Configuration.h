...
#define STRING_CONFIG_H_AUTHOR "(TheThomasD)" // Original author or contributor.
...
#define PIDTEMPBED
  ...
  #define DEFAULT_BED_KP  23.78
  #define DEFAULT_BED_KI   4.50
  #define DEFAULT_BED_KD  83.71
...
#define DELTA
  ...
  #define PRINTABLE_RADIUS       105.0    // (mm)

  // Center-to-center distance of the holes in the diagonal push rods.
  #define DELTA_DIAGONAL_ROD 215.0        // (mm)

  // Distance between bed and nozzle Z home position
  #define DELTA_HEIGHT 199.87             // (mm) Get this value from G33 auto calibrate

  #define DELTA_ENDSTOP_ADJ { 0.0, -0.27, -0.31 } // (mm) Get these values from G33 auto calibrate

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS 106.36              // (mm) Get this value from G33 auto calibrate

  // Trim adjustments for individual towers
  // tower angle corrections for X and Y tower / rotate XYZ so Z tower angle = 0
  // measured in degrees anticlockwise looking from above the printer
  #define DELTA_TOWER_ANGLE_TRIM { -0.27, 0.19, 0.07 } // (mm) Get these values from G33 auto calibrate
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 80, 426.37 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -2.7, -2.1, -20.185 } // (mm) X, Y, Z distance from Nozzle tip to Probe trigger-point
...
#define TOUCH_SCREEN
  ...
  #define BUTTON_DELAY_MENU     400 // (ms) Button repeat delay for menus
