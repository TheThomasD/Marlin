...
#define KNUTWURST_MEGA TRIGORILLA_MAPPING_I3MEGA
#define KNUTWURST_CHIRON TRIGORILLA_MAPPING_CHIRON
#define KNUTWURST_BLTOUCH BLTOUCH
#define CUSTOM_BUILD_VERSION "0.0.1"
